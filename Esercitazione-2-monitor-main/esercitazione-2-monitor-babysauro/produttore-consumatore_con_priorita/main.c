...
int main(int argc,char* argv[])
{
	...
	id_prod_cons= IPC_PRIVATE; /* TBD: Allocare una memoria condivisa per la struttura "PriorityProdCons" */
	shmget(id_prod_cons, sizeof(PriorityProdCons), IPC_CREAT|0644);
